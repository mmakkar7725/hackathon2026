...
export const medicalDictionary: MedicalDictionaryEntry[] = [
  ...
  },
  {
    ...
    code: "R53.83",
    category: "symptom",
    synonyms: ["fatigue", "tired", "tiredness", "exhaustion", "weakness", "weakness and fatigue"],
  },
  {
    id: "icd10-r19.7",
    name: "Myalgia",
    ...
    code: "R19.7",
    category: "symptom",
    synonyms: ["myalgia", "muscle ache", "muscle pain", "aches", "body aches", "joint aches"],
  },
  {
    id: "icd10-j30.9",
    ...
    code: "J30.9",
    category: "symptom",
    synonyms: ["rhinitis", "runny nose", "nasal congestion", "congestion", "mucus in throat", "sinus congestion"],
  },
  {
    id: "snomed-422400008",
    name: "Vomiting",
